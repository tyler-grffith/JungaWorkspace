...
- Module documents should expose a `render for presentation` path (static SVG for graphs, static table for sheets) that both the in-app views and the export targets reuse.
